...
if(stim_count == stim_per_interval)
    audio_clip(1,position:(position+length(interval_break)-1)) = 0;
    audio_clip(2,position:(position+length(interval_break)-1)) = 0;
...
figure;
hold on;
plot(time(150000000:end),trigger_signal(150000000:end));
plot(time(150000000:end),audio_clip(1,150000000:end));
ylabel('amplitude');
xlabel('time [s]');
